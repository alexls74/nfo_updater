...
// Раньше он был скопирован в оба провайдера в виде pickKey(), причём
// в усечённом виде: ключ выбывал только по локальному счётчику, а на отказ
// сервиса реакции не было вовсе.
//
