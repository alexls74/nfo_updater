...
// полностью и ведёт себя предсказуемо. Альтернатива — пинги через
// golang.org/x/net/http2 — потребовала бы внешней зависимости, которых
...
// "поведение по умолчанию", то есть HTTP/2 включён.
