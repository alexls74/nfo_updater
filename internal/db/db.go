...
// DB — обёртка над *sql.DB с методами, специфичными для нашей схемы.
...
//
// TVDb нужен потому, что в tvshow.nfo тег <id> означает именно TVDB ID,
// и сериал вполне может не иметь ни IMDb, ни TMDb идентификатора.
//
